...
**Version incluse :** 6.52~ynh1 *(:warning: Il s'agit de la branche `testing`. La [branche `master`](https://github.com/YunoHost-Apps/wekan_ynh/tree/master) utilisée dans le catalogue est actuellement en 6.51\~ynh1.)*
